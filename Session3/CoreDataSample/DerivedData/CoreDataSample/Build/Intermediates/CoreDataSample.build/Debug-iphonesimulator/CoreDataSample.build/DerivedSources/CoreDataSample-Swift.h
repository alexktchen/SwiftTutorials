...
SWIFT_CLASS("_TtC14CoreDataSample11AppDelegate")
...
SWIFT_CLASS("_TtC14CoreDataSample4User")
...
SWIFT_CLASS("_TtC14CoreDataSample14ViewController")
@interface ViewController : UIViewController <UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITextField * __null_unspecified addTextField;
@property (nonatomic, weak) IBOutlet UITextField * __null_unspecified qureyTextField;
...
- (IBAction)RefreshButton:(id __nonnull)sender;
- (IBAction)addButtonTochDown:(id __nonnull)sender;
- (void)getUsers;

...
SWIFT_CLASS("_TtC21MultipleThreadsSample11AppDelegate")
...
SWIFT_CLASS("_TtC21MultipleThreadsSample24CollectionViewController")
...
SWIFT_CLASS("_TtC21MultipleThreadsSample19TableViewController")
...
SWIFT_CLASS("_TtC21MultipleThreadsSample14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * __null_unspecified image;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)downloadButtonTouchDown:(id __nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
